                    ...
                    <div class="space-y-3">
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-bold bg-emerald-500/20 text-emerald-400 rounded-full border border-emerald-500/30 backdrop-blur-sm">
                                <i class="fas fa-calendar-alt text-[8px]"></i> Semester {{ date('Y') == '2026' ? 'Ganjil' : 'Genap' }} {{ date('Y') }}/{{ date('Y')+1 }}
                            </span>
                        </div>
                ...
                <div class="group animate-fade-in-up" style="animation-delay: {{ $index * 0.05 }}s">
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full">
                            ...
                            <div class="relative flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-1">
                                    <span class="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                                        <i class="fas fa-book text-white/70 text-xs group-hover:rotate-12 transition-transform duration-300"></i>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="p-5 flex-1">
                            <div class="mb-3">
                                <span class="text-[10px] font-mono text-slate-400 font-bold tracking-wider uppercase bg-slate-100 px-2 py-0.5 rounded-lg">
                                    <i class="fas fa-barcode mr-1 text-[8px]"></i>
                                    Code: {{ $row->kode_matakuliah }}
                                </span>
                                <h3 class="font-extrabold text-slate-800 text-base leading-snug line-clamp-2 min-h-[3rem] mt-2 group-hover:text-indigo-600 transition-colors">
                            ...
                            <div class="pt-3 border-t border-slate-100 text-xs text-slate-500 space-y-3">
                                ...
                                <div class="flex items-center gap-2.5 group/item">
                                    <div class="w-7 h-7 rounded-lg bg-indigo-50 flex items-center justify-center text-indigo-600 shrink-0 group-hover/item:bg-indigo-600 group-hover/item:text-white transition-all duration-200">
                                        <i class="far fa-clock text-[11px]"></i>
                                    </div>
                                    <div>
                                        <p class="font-semibold text-slate-700 text-sm">{{ $row->hari ?? 'Hari belum ditentukan' }}</p>
                                ...
                                {{-- Semester --}}
                                <div class="flex items-center gap-2.5 group/item">
                                    <div class="w-7 h-7 rounded-lg bg-emerald-50 flex items-center justify-center text-emerald-600 shrink-0 group-hover/item:bg-emerald-600 group-hover/item:text-white transition-all duration-200">
                                ...
                                <div class="flex items-center gap-2.5 group/item">
                                    <div class="w-7 h-7 rounded-lg bg-purple-50 flex items-center justify-center text-purple-600 shrink-0 group-hover/item:bg-purple-600 group-hover/item:text-white transition-all duration-200">
